...
export const TICKET_PRICES = { STANDARD: 850, BACK_ROW: 500 };
export const BACK_ROW_CAPACITY = 45; // Q(24) + R(21)
export const BACK_ROW_LETTERS = ['Q', 'R'];
...
export const SEATING_ZONES = {
  ...
  BACK_ROW: {
    ...
    status: 'AVAILABLE',
    description: 'Rows Q & R — Back Row Seats (₹500)',
  },
};
...
export function getSeatZoneAndStatus(rowLetter, num) {
  ...
  // Rows Q and R are back-row seats (₹500 tier)
